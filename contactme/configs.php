...
$configs['from_name']				= 'MyEpil | Fotodepilación';					// Your name will be used in emails
$configs['from_address']			= 'web@aq8system.com';							// Your email address used to send emails
$configs['to_addresses']			= array('web@aq8system.com');					// The addresse(s) where to send all the requests
/* END - Required Config */

/* START - Optional Configs */
$configs['lang_path']				= 'lang/ru.json';								// Path to the language file
